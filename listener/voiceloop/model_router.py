    ...
    async def plan(
        ...
        *,
        ...
        system_prompt = (
            ...
            "jako high oraz confirmation_required=true. Styl asystentki: ciepła, "
            "pewna siebie, rzeczowa i profesjonalna. Nie używaj wulgarności; w "
            "kontekstach medycznych, prawnych i technicznych zachowuj szczególnie "
            "precyzyjny ton i jasno komunikuj ograniczenia."
        )
